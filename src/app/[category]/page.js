...
import { modify, fetchMeta } from "../../../components/redux/slices/searchResultsSlice";
import EventCard from "../../../components/home-page-componets/event-card";
import SubCategoryPills from "../../../components/category-page-components/subcategory_pills";
import { usePathname } from "next/navigation";
const CategoryPage = () => {
  let category = decodeURIComponent(usePathname().slice(1));
